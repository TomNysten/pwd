 ...
 */
final class Version20200121135352 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comments (id INT AUTO_INCREMENT NOT NULL, auteur_id INT NOT NULL, posted_on_card_id INT DEFAULT NULL, posted_on_user_id INT DEFAULT NULL, posted_at DATETIME NOT NULL, content LONGTEXT NOT NULL, flagged TINYINT(1) NOT NULL, validated TINYINT(1) NOT NULL, INDEX IDX_5F9E962A60BB6FE6 (auteur_id), INDEX IDX_5F9E962AC237EFDF (posted_on_card_id), INDEX IDX_5F9E962A2F95A66A (posted_on_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
